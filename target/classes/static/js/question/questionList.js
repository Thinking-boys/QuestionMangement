    ...
    layui.use('table', function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[
                ...
                , {field: 'createdDate', title: '发布时间', align: 'center'}
                , {field: 'commentCount', title: '评论数量',}
                , {field: 'likeCount', title: '点赞数量',}
                , {field: 'followCount', title: '关注数量',}
                , {field: 'grade', title: '分数',}
                , {field: 'isDelete', title: '是否删除', width: 95, align: 'center', templet: '#isDelete'}
                , {field: 'isTop', title: '是否置顶', width: 95, align: 'center', templet: '#isTop'}
